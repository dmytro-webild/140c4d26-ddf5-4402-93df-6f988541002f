...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/high-angle-delicious-seafood-wine_23-2149410733.jpg",
          alt: "High angle delicious seafood and wine",
        },
        {
          src: "http://img.b2bpic.net/free-photo/high-angle-safari-party-with-drinks-snacks_23-2149707894.jpg",
          alt: "High angle safari party with drinks and snacks",
        },
        {
        ...
        },
        {
          ...
          alt: "High angle delicious sea food",
        },
        {
          src: "http://img.b2bpic.net/free-photo/group-young-people-having-wine-together_23-2148454082.jpg",
          alt: "elegant diner enjoying meal",
        },
      ]}
      buttons={[
        {
      ...
      products={[
        {
          ...
          price: "28€",
          imageSrc: "http://img.b2bpic.net/free-photo/large-poon-choi-bowl-filled-with-layered-meats-seafood-lunar-new-year-celebration-table_123827-36974.jpg",
        },
        {
          id: "2",
          name: "Spaghetti agli Scampi",
          price: "22€",
          imageSrc: "http://img.b2bpic.net/free-photo/stir-fried-spaghetti-seafood_1339-3424.jpg",
        },
        {
          id: "3",
        ...
        },
        {
          ...
          name: "Zuppa di Mare",
          price: "24€",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-assortment-seafood-with-cutlery_23-2148643671.jpg",
        },
        {
          id: "5",
          name: "Insalata di Mare",
          price: "16€",
          imageSrc: "http://img.b2bpic.net/free-photo/oysters-sauce-with-salad_140725-4134.jpg",
        },
        {
          id: "6",
          name: "Filetto del Giorno",
          price: "26€",
      ...
      metrics={[
        {
          ...
          description: "Passione e tradizione dal 2006",
          icon: Clock,
        },
        {
          id: "2",
        ...
        },
        {
          id: "3",
          value: "100+",
          title: "Piatti in Menu",
          description: "Una selezione completa di mare",
          icon: Fish,
        },
      ]}
